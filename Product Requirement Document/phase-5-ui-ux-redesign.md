...
- [x] Design tokens defined in Tailwind config and applied consistently (`Collect-RX-main/tailwind.config.ts`, `index.html` CDN mirror, `App.css`)
...
- [x] Storybook documents core primitives (`Collect-RX-main/src/components/ui/*.stories.tsx`); extend as new components ship
