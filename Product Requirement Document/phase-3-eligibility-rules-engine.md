...
- [x] Rules engine returns estimate for all 6 carriers given a CDT code + patient plan (`Collect-RX-main/src/services/eligibility/`, `carrier-configs.json`)
- [x] COB calculation correct for dual-coverage test cases (`Collect-RX-main/tests/eligibility.test.ts`)
