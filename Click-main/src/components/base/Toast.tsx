  ...
  return (
    <div
      ...
      className={[
        ...
        'rounded-lg bg-white p-4 shadow-lg ring-1 ring-gray-200',
    ...
    >
      ...
      <button
        ...
        className={[
          'shrink-0 rounded p-1 text-gray-400',
...
// ── Viewport (rendered inside ToastProvider) ──────────────────────────────────
...
function ToastViewport() {
  ...
  return (
    <div
      ...
      className="fixed bottom-4 right-4 z-[1000] flex flex-col gap-2 w-full max-w-sm pointer-events-none"
    >
      {toasts.map(t => (
