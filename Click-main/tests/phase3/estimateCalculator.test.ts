...
describe('Multi-Procedure Estimates', () => {
  ...
  it('returns correct totals for mixed categories', () => {
    ...
    // D1110 cleaning (preventive) = 110 * 100% = 110
    // D0272 bitewing (preventive/diagnostic) = 55 * 100% = 55
    // D2391 composite (basic) = 175 * 80% = 140
    // Total insurance = 110 + 55 + 140 = 305
    expect(result.totalInsurancePays).toBeCloseTo(305, 0);
