...
> **Retired copy (2026-07-14).** Canonical PRDs live in [`../docs/prd/`](../docs/prd/README.md). Prefer that folder. Product is multi-tenant **Practice→Insurance** only (patients are claim subjects, not payers). See [`../../docs/product/MVP-SCOPE.md`](../../docs/product/MVP-SCOPE.md).
