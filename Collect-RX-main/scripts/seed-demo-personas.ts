...
const PERSONAS: Array<{ email: string; role: PracticeRole; displayName: string; providerId?: string; tokenDays?: number }> = [
  { email: 'om@maplegrovedental.ca', role: 'office_manager', displayName: 'Olivia Manager' },
  { email: 'billing@maplegrovedental.ca', role: 'billing_coordinator', displayName: 'Ben Coordinator' },
  { email: 'desk@maplegrovedental.ca', role: 'front_desk', displayName: 'Fran Desk' },
  { email: 'associate@maplegrovedental.ca', role: 'associate_dentist', displayName: 'Dr. Ash Associate', providerId: 'DR-001' },
  { email: 'accountant@maplegrovedental.ca', role: 'accountant', displayName: 'Alex Accountant', tokenDays: 90 },
  { email: 'group@maplegrovedental.ca', role: 'group_admin', displayName: 'Grace Group' },
];
