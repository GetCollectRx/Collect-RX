...
-- Rows that cannot be tied to a practice via Patient.id or PatientBalance.abeldentPatientId are deleted.
...
-- Drop legacy non–tenant-scoped index names (ignore if absent)
...
CREATE INDEX "eligibility_snapshots_practice_id_patient_id_carrier_verified_at_idx"
...
CREATE INDEX IF NOT EXISTS "PatientBalance_patientPhone_idx" ON "PatientBalance" ("patientPhone");
