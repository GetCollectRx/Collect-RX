...
| **P4-05** | Vapi | `POST /api/vapi/webhook` with secret + idempotency | [ ] Vapi custom credential matches `VAPI_WEBHOOK_SECRET`. [ ] Rotate: update both sides; see [SECRETS-GO-LIVE.md](SECRETS-GO-LIVE.md). |
| **P4-06** | Secrets | [SECRETS-GO-LIVE.md](SECRETS-GO-LIVE.md) | [ ] All secrets in **host** vars. [ ] **Break-glass** and rotation documented. [ ] No secrets in repo. |
